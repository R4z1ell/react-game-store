...
class GameCard extends Component {
  ...
  render() {
    const faWindowsClass = this.props.user.userData.cart.some(
      game => game.id === this.props._id
    )
      ? '10px'
      : '0px';

    const productTileInfoClass = this.props.prices.discount ? '32px' : '39px';
    const gameCardBuyBlockClass = this.props.prices.discount
      ? '77.5%'
      : '83.2%';
    ...
    return this.props.grid ? (
      <div style={{ position: 'relative' }} className="link-wrapper">
        ...
        <div className="game-card__info">
          ...
          <div
            className="game-card__buy-block"
            style={{ top: gameCardBuyBlockClass }}
          >
            <div className="game-card__prices">
              ...
              <div className="game-card__prices-inner">
                {this.props.prices.discount ? (
                  <span className="game-card__base-price">
                    <FontAwesomeIcon icon={faEuroSign} />
                    {this.props.prices.basePrice / 100}
                  </span>
                ) : (
                  <span className="game-card__base-price no-discount">
                    <FontAwesomeIcon icon={faEuroSign} />
                    {this.props.prices.basePrice / 100}
                  </span>
                )}
                {this.props.prices.discount ? (
                  <span className="game-card__price-discounted">
                    <FontAwesomeIcon icon={faEuroSign} />
                    {discountedPrice}
                  </span>
                ) : null}
            ...
            {this.props.user.userData.cart.some(
              ...
              <button
                className="game-card__button game-card__button--clicked"
                style={{ top: gameCardBtnClass }}
              >
                <svg
                  viewBox="0 0 16 14"
                  width="100%"
      ...
      <div className="product-tile product-tile--list">
          ...
          <div className="product-tile__title">
            ...
            <div className="product-tile__platform">
              {this.props.user.userData.cart.some(
                ...
                <div className="product-tile__labels product-tile__labels--in-cart">
                  <FaShoppingCart
                    fill="#fff"
                    size="1em"
              ...
              <FaWindows
                ...
                style={{ marginLeft: faWindowsClass }}
              />
            </div>
          </div>
          <div
            className="product-tile__info"
            style={{ top: productTileInfoClass }}
          >
            <div className="product-tile__buy-block">
              <div className="product-tile__prices">
                {this.props.prices.discount ? (
                  <span className="product-tile__discount">
                    -{this.props.prices.discount}%
                  </span>
                ) : null}
                <div className="product-tile__prices-inner">
                  {this.props.prices.discount ? (
                    <span className="product-tile__base-price">
                      <FontAwesomeIcon icon={faEuroSign} />
                      {this.props.prices.basePrice / 100}
                    </span>
                  ) : (
                    <span className="product-tile__base-price no-discount">
                      <FontAwesomeIcon icon={faEuroSign} />
                      {this.props.prices.basePrice / 100}
                    </span>
                  )}
        ...
        {!this.props.user.userData.cart.some(
          ...
          <button className="product-tile__button" onClick={this.sendToCart}>
            <svg
              viewBox="0 0 16 13"
              width="100%"
              height="100%"
          ...
          <button className="product-tile__button product-tile__button--clicked">
            <svg
              viewBox="0 0 16 14"
              width="100%"
              height="100%"
